...
<template>
    <div class="hero relative wfull h60dvh xl:h70dvh bg-[url('/images/services-hero.jpg')] bg-cover bg-center bg-no-repeat -mt20 lg:-mt24">
        ...
        <div class="w-content2">
            <div class="flex-col flex lg:flex-row-reverse gap10 lg:gap12 text-[#757575]">
                <div class="lg:w-1/2" data-aos="fade-left">
                    ...
                    <button class="flex btn text-white items-center gap1 lg-gap2 bg-e-primary mt4 px-4 xl-px6 py-3  text-4 border-2 border-e-primary rounded-2 font-600" @click="goToContact()">
