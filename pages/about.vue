    ...
    <div class="bg-[#E4F4F3] py10 lg:py20 bg-[url('/images/lowsvg.svg')] bg-no-repeat bg-pos-left-bottom">
        <div class="w-content">
            ...
            <div class="flex flex-col lg:flex-row gap8 lg:gap10 mt15 lg:mt40 mb20">
                <div class="bg-white rounded-3 lg:rounded-5 px8 py10 lg:w-1/3">
                    <div class="flex gap2 items-center fw600 mb5">
                        <svg class="h8 w8" viewBox="0 0 55 62" fill="none" xmlns="http://www.w3.org/2000/svg">
