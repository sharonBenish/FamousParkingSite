...
<template>
    ...
    <div class="bg-white lg:py30 lg:bg-[url('/images/Vector1.svg')] bg-no-repeat bg-pos-right-top my-15">
        <div class="w-content lg:flex text-[#757575]">
            ...
            <div class="bg-white lt-lg:mt10 lg:relative top-16 -left-16 shadow-custom flex flex-col items-center rounded-4 lg:rounded-7.5 px6 pt6 pb10 lg:py10 lg:px8 text-center hmin">
