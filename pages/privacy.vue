...
<template>
    <div class="w-site">
        ...
        <div>
            ...
            <p>Among the types of Personal Data that Famousparking.com collects, by itself or through third parties, there are: Cookies; Usage Data; first name; last name; email address; date of birth; phone number; address; password; geographic position; Data communicated while using the service.</p>
            ...
            Personal Data may be freely provided by the User, or, in case of Usage Data, collected automatically when using FamousParking.com.<br />
            Unless specified otherwise, all Data requested by FamousParking.com is mandatory and failure to provide this Data may make it impossible for FamousParking.com to provide its services. In cases where FamousParking.com specifically states that some Data is not mandatory, Users are free not to communicate this Data without consequences to the availability or the functioning of the Service.<br/>
            Users who are uncertain about which Personal Data is mandatory are welcome to contact the Owner.<br/>
            Any use of Cookies – or of other tracking tools — by FamousParking.com or by the owners of third-party services used by FamousParking.com serves the purpose of providing the Service required by the User, in addition to any other purposes described in the present document and in the Cookie Policy.<br/></p>

            <p>>Users are responsible for any third-party Personal Data obtained, published or shared through FamousParking.com.</p>
            ...
            The Data processing is carried out using computers and/or IT enabled tools, following organizational procedures and modes strictly related to the purposes indicated. In addition to the Owner, in some cases, the Data may be accessible to certain types of persons in charge, involved with the operation of FamousParking.com (administration, sales, marketing, legal, system administration) or external parties (such as third-party technical service providers, mail carriers, hosting providers, IT companies, communications agencies) appointed, if necessary, as Data Processors by the Owner. The updated list of these parties may be requested from the Owner at any time</p>
            ...
            <p>This service allows FamousParking.com to connect with the User's account on Stripe, provided by Stripe, Inc.</p>
            ...
            <p>This type of service allows User Data to be utilized for advertising communication purposes. These communications are displayed in the form of banners and other advertisements on FamousParking.com, possibly based on User interests.<br />
            ...
            <p>Google Ads conversion tracking is an analytics service provided by Google LLC that connects data from the Google Ads advertising network with actions performed on FamousParking.com.</p>

            <p>Personal Data processed: Trackers; Usage Data.</p>

            <p>Place of processing: United States – Privacy Policy.</p>

            <h4>Direct Marketing via SMS (FamousParking.com)</h4>

            <p>FamousParking.com uses the User Data to propose services and products provided by third parties or unrelated to the product or service provided by FamousParking.com.</p>

            <p>Personal Data processed: phone number.</p>

            <h4>Meta ads conversion tracking (Meta pixel) (Meta Platforms, Inc.)</h4>

            <p>Meta ads conversion tracking (Meta pixel) is an analytics service provided by Meta Platforms, Inc. that connects data from the Meta Audience Network with actions performed on FamousParking.com. The Meta pixel tracks conversions that can be attributed to ads on Facebook, Instagram and Meta Audience Network.</p>
            ...
            <p>Google Analytics (Universal Analytics) is a web analysis service provided by Google LLC or by Google Ireland Limited, depending on how the Owner manages the Data processing, (“Google”). Google utilizes the Data collected to track and examine the use of FamousParking.com, to prepare reports on its activities and share them with other Google services.<br />
            ...
            <h4>Analytics collected directly (FamousParking.com)</h4>

            <p>FamousParking.com uses an internal analytics system that does not involve third parties.</p>

            <p>Personal Data processed: Cookies; Usage Data.</p>

            <h3>E. Contacting the User</h3>

            <h4>Contact form (FamousParking.com)</h4>
