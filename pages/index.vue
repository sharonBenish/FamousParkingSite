...
<template>
    ...
    <div class="hero relative wfull h100dvh md:h85dvh 3xl:h70dvh bg-[url('/images/Hero-img.svg')] bg-center bg-cover -mt20 lg:-mt22">
        <div class="hero-text text-white absolute bottom-20 lt-2xl:w-site 2xl:w-[80%] right-1/2 left-1/2 -translate-x-1/2 z-200">
            <h1 class="font-800 text-10 2md:text-12 xl-text-18 lg:w250 mb6" data-aos="fade-down" data-aos-delay="500" data-aos-easing="linear">Get Famous. Make Money.</h1>
            <div class="lg-flex lg-flex-row justify-between items-end">
                <p class="font-600 xl:text-5 w120 md:w150 2xl:180">We handle parking management needs so you can focus on what matters. Start today!</p>
    ...
    <div class="lg:w-content">
        <div class="w-content lg-my-20 shadow-custom lg-rounded-7 text-center px0 ">
            <div class="px-6 2md:px-20 lg-px30 py20">
            ...
            <div class="bg-[#E4F4F3] px-6 2md:px-20 lg-px30 py20">
