          ...
          <div class="">
            <div class="flex-c justify-end space-x-4.5">
              <NuxtLink
                ...
                :class="[route.fullPath.includes(item.to) ? 'nav-active text-green-7' : '']"
              >
                {{ item.head }}
              </NuxtLink>
              ...
              <button class="flex items-center gap-2 bg-e-primary px5 py3 rounded-2 text-white font-600 lt-lg-hidden">
